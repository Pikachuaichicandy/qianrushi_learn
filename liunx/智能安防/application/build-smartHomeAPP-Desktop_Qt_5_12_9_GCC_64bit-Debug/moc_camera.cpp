...
QT_MOC_LITERAL(1, 7, 7), // "sendPix"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 8), // "QPixmap&"
QT_MOC_LITERAL(4, 25, 5), // "frame"
QT_MOC_LITERAL(5, 31, 9) // "videoShow"

    },
    "camera\0sendPix\0\0QPixmap&\0frame\0videoShow"
};
...
void camera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendPix((*reinterpret_cast< QPixmap(*)>(_a[1]))); break;
        case 1: _t->videoShow(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (camera::*)(QPixmap & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&camera::sendPix)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void camera::sendPix(QPixmap & _t1)
{
