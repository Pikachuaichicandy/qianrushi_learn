...
#include "../smartHomeAPP/controler.h"
...
QT_MOC_LITERAL(1, 10, 15), // "sendCommandData"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 11) // "commandData"

    },
    "controler\0sendCommandData\0\0commandData"
};
...
void controler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendCommandData((*reinterpret_cast< unsigned char(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (controler::*)(unsigned char );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&controler::sendCommandData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void controler::sendCommandData(unsigned char _t1)
{
