...
__attribute__((section("__versions"))) = {
	...
	{ 0x44e281c8, __VMLINUX_SYMBOL_STR(devm_pwm_get) },
	...
	{ 0x9cb34369, __VMLINUX_SYMBOL_STR(pwm_disable) },
...
MODULE_ALIAS("of:N*T*Calientek,gpioled*");

MODULE_INFO(srcversion, "C669C173778C03C94BF62B9");
