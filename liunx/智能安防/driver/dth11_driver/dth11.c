...
static int dth11_ioinit(void)
{
    ...
    dth11.gpio_dth11 = of_get_named_gpio(dth11.nd, "dth11-gpios", 0);
    ...
    gpio_request(dth11.gpio_dth11, "dth11-gpios");
...
{
    static int initialized = 0; /* 标志位，确保ioinit只执行一次 */
    int ret = 0;
