...
QT_MOC_LITERAL(2, 31, 0) // ""
    ...
    "ranklist\0on_pushButton_clicked\0"
};
...
void ranklist::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ranklist *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ranklist::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_ranklist.data,
    qt_meta_data_ranklist,
    qt_static_metacall,
    nullptr,
    nullptr
} };
